...
class LocationController extends GetxController {
  ...
  var selectedLocation = const Location('Brasil', 'br', 55).obs;
  Rx<TextEditingController> countryCodeInputController = TextEditingController().obs;
  Rx<TextEditingController> phoneNumberInputController = TextEditingController().obs;
...
class Location {
  ...
  String getFlag() {
    ...
    String flag = countryCode.toUpperCase().replaceAllMapped(RegExp(r'[A-Z]'), (match) => String.fromCharCode((match.group(0)?.codeUnitAt(0) as int) + 127397));
    return flag;
  }
}
